...
<script src='<?php echo $control->createLink('chat', 'registerComponent', 'referer=' . helper::safe64Encode($control->server->request_uri) . '&version=' . time());?>' type='text/javascript'></script>
<?php endif;?>
