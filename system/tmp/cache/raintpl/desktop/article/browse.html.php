        ...
        <?php foreach($articles as $article): ?>
          ...
          <div class='item' id="article<?php echo $article->id;?>" data-ve='article'>
            <?php if(!empty($article->image)){ ?>
              ...
              <?php $imageSize=$this->var['imageSize'] = !empty($control->config->article->imageSize) ? $control->config->article->imageSize . 'URL' : 'smallURL';?>
              ...
              <div class='media <?php echo $pull;?>'>
                ...
                <?php echo html::a($url, html::image($control->loadModel('file')->printFileURL($article->image->primary, $imageSize), "title='$title' style='max-width:$maxWidth' class='thumbnail'")); ?>
