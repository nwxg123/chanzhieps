...
ALTER TABLE `eps_im_chat` ADD `lang` char(30) NOT NULL DEFAULT 'all';
ALTER TABLE `eps_im_message` ADD `lang` char(30) NOT NULL DEFAULT 'all';
ALTER TABLE `eps_im_chatuser` ADD `lang` char(30) NOT NULL DEFAULT 'all';
ALTER TABLE `eps_im_messagestatus` ADD `lang` char(30) NOT NULL DEFAULT 'all';
