      ...
      <form method='post' action='<?php echo inlink('setresponse', "public={$public}&group={$group}&key={$key}");?>' id='responseForm'>
        <table class='table table-form'>
          ...
          <tr>
            ...
            <td class='col-xs-8'><?php echo html::input('key', isset($response->key) ? $response->key : '', "class='form-control'");?></td>
            <td></td>
          </tr>
          <?php endif;?>
          <tr>
            <th class='w-100px'><?php echo $lang->wechat->response->type;?></th>
            <td class='col-xs-8'><?php echo html::select('type', $lang->wechat->response->typeList,  isset($response->type) ? $response->type : '', "class='form-control'");?></td>
            <td></td>
          </tr>
