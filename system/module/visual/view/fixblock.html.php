...
<form method='post' action='<?php echo inlink('fixblock', "page={$layout->page}&region={$layout->region}&block={$block->id}&object={$object}");?>' class='ve-form mw-800px center-block' enctype='multipart/form-data'>
