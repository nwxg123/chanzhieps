...
<div class='panel panel-head'>
  <div class='panel-body'>
    <div class='panel-mtag pull-left col-xs-6 text-center'>
      <div class='head-title'><?php echo $lang->stat->page->views;?></div>
      <div class='today-number'><?php echo $pvTotal;?></div>
    </div>
    <div class='panel-mtag pull-left col-xs-6 text-center'>
      <div class='head-title'><?php echo $lang->stat->page->message;?></div>
      <div class='today-number'><?php echo $messageTotal;?></div>
    </div>
  </div>
