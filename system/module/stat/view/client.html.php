...
<section class='main-table'>
  <header class='clearfix'>
    <ul class='nav nav-tabs-main pull-left'>
      ...
      <li <?php if($mode == $code) {echo "class='active'";}?>>
        <?php echo html::a(inlink('client', "type={$type}&mode=$code"), $modeName);?>
      </li>
      <?php endforeach;?>
    </ul>
  ...
  <div class='panel-body'>
    ...
    <div class='row' style='clear:both'>
      <div class='col-md-6'>
        <canvas height='300' width='800' id='pieChart'></canvas>
        <div class='text-center' id='switchBar'>
