...
$lang->ui->suitableLogoSize       = '最佳高度：%s，最佳寬度：%s';
...
$lang->effect->noRsults      = "你還沒有任何特效，請登錄蟬知特效平台。<a href='http://www.chanzhi.org/effect.html' class='btn btn-xs btn-primary' target='_blank'>獲取特效</a>";
