<table class='table-1 f-12px' align='center'>
  ...
  <tr class='text-center'>
    <td><?php echo $i ++;?></td>
    <th class='text-left'><?php echo html::a($this->createLink('file', 'download', "id=$file->id"), $file->title, "target='_blank'");?></th>
    <td><?php echo $file->extension;?></td>
    <td><?php echo $file->size;?></td>
    <td><?php echo $file->addedDate;?></td>
    <td><?php echo $file->score;?>
    <td><?php echo $file->downloads;?></td>
    <td><?php echo html::a($this->createLink('file', 'download', "id=$file->id"), $lang->file->download, "target='_blank' class='red'");?></td>
  </tr>
  <?php endforeach;?>
