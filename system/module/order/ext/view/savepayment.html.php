    ...
    <tr>
      ...
      <td>
        <div class='input-control has-icon-right'>
          <?php echo html::input('paidDate', date('Y-m-d H:i'), "class='form-control form-datetime' data-picker-position='top-right'");?>
          <label for="paidDate" class="input-control-icon-right"><i class="icon icon-calendar"></i></label>
        </div>
      </td>
    </tr>
    <tr>
