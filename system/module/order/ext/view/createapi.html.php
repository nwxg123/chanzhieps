    ...
    <form id='ajaxForm' method='post'>
      <table class='table table-form w-p60'>
        <tr>
          ...
          <td><?php echo html::select('action', $lang->order->api->actionList, '', "class='form-control chosen'");?></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><?php echo html::radio('debug', $lang->order->api->turnonList, '');?></td>
        </tr>
        <tr>
          <th><?php echo $lang->order->api->method;?></th>
          <td><?php echo html::radio('method', $lang->order->api->methodList, 'get');?></td>
        </tr>
        <tr>
