...
.alert-deny {max-width: 500px; margin: 8% auto; padding: 0; background-color: #FFF; border: 1px solid #ccc; box-shadow: 0px 2px 20px rgba(0, 0, 0, 0.2); border-radius: 0; padding: 10px
  ...
  <div class='alert alert-deny'>
    ...
    <div class='content'>
      ...
      <div class='actions text-center'>
        {!html::a(helper::createLink('user', 'balance'), $lang->order->viewBalance, "class='btn primary block'")}
      </div>
    </div>
  </div>
</div>
