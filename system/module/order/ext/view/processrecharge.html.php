...
<div class='container' id='payResult'>
  ...
  <div class='modal-body'><div class='alert alert-success text-center'><h4><i class="text-success icon-ok-sign"></i> {$lang->order->rechargeSuccess}</h4></div></div>
  <div class='modal-footer'>{!html::a(helper::createLink('trade', 'browse'), $lang->order->viewBalance, "class='btn btn-success'")}</div>
</div>
