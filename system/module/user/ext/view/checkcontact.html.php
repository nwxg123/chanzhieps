...
<table class='table table-form'>
  ...
  <tr>
    ...
    <td>
      <?php echo $user->email;?>
      <?php if(zget($user, 'emailCertified', 0) == 1) echo "<span class='label label-success'> {$lang->user->certified}</span>";?>
    </td>
  </tr> 
  ...
  <tr>
    ...
    <td>
      ...
      <?php if(zget($user, 'mobileCertified', 0) == 1) echo "<span class='label label-success'> {$lang->user->certified}</span>";?>
    </td>
  </tr> 
  <?php endif;?>
