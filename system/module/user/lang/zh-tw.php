...
$lang->user->errorUnAuthorized = "抱歉，您所訪問的網站因授權原因暫停『<b>%s</b>』模組，如有疑問，請聯繫網站管理員。<br/>點擊後退返回上頁。5秒鐘後將自動返迴首頁...";
...
$lang->user->statusList->locked    = "<span class='span span-danger'>鎖定</span>";
...
$lang->user->stateList['admin'] = '管理員(%d)';
$lang->user->stateList['qq']    = 'QQ會員(%d)';
$lang->user->stateList['email'] = '郵箱認證(%d)';
