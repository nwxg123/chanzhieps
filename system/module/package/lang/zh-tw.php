...
$lang->package->status        = '狀態';
$lang->package->control       = '控制';
$lang->package->obtain        = '獲取插件';
...
$lang->package->executeCommands          = '<h3 class="text-center">執行下面的命令來修正這些問題：</h3>';
...
$lang->package->errorCheckIncompatible       = '該插件與蟬知版本不兼容，%s後可能無法使用。。<h3>您可以選擇 <a href="#" url="%s" class="model-jump">強制%s</a> 或者 <a href="#" onclick="window.location.reload()">取消</a></h3>';
...
$lang->package->stateList['installed']   = '已安裝(%d)';
$lang->package->stateList['available']   = '已下載(%d)';
