...
$lang->product->viewCount   = '閲讀 : %d';
$lang->product->underReview = '待審核 : %d';
$lang->product->reviewed    = '已發佈 : %d';
$lang->product->css         = 'CSS';
$lang->product->js          = 'JS';

$lang->product->currency     = '貨幣';
$lang->product->stock        = '庫存';
$lang->product->stockRemind  = '庫存提醒';
$lang->product->stockWarning = "<span class='first'>當庫存小於</span>%s<span>時進行預警</span>";
