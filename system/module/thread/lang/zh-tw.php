...
$lang->thread->file        = '附件: ';
$lang->thread->postedDate  = '發表時間';
$lang->thread->replies     = '回帖';
$lang->thread->replyCount  = '回帖數';
$lang->thread->views       = '閲讀數';
...
$lang->thread->status         = '帖子狀態';
$lang->thread->approve        = '審核';
$lang->thread->display        = '顯示';
$lang->thread->hide           = '隱藏';
$lang->thread->show           = '顯示狀態';
...
$lang->thread->displayList['hidden'] = '隱藏';
$lang->thread->displayList['normal'] = '顯示';

$lang->thread->statusList['wait']     = '待審核';
$lang->thread->statusList['approved'] = '已通過';
