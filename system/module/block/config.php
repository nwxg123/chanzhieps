...
$config->block->categoryList->article = ',latestArticle,hotArticle,latestBlog,latestThread,pageList,articleTree,blogTree,latestBook,subscribe,';
$config->block->categoryList->product = ',latestProduct,hotProduct,featuredProduct,productTree,';
$config->block->categoryList->system  = ',contact,message,followUs,about,links,slide,header,bottomNav,login,';

$config->block->categoryGroups = new stdclass();
$config->block->categoryGroups->system['layout']    = '';
$config->block->categoryGroups->system['structure'] = ',header,bottomNav,';
$config->block->categoryGroups->system['function']  = ',slide,message,login,';
$config->block->categoryGroups->system['spread']    = ',links,contact,about,followUs,';
$config->block->categoryGroups->article['article']  = ',articleTree,latestArticle,hotArticle,';
$config->block->categoryGroups->article['forum']    = ',latestThread,';
$config->block->categoryGroups->article['book']     = ',latestBook,';
$config->block->categoryGroups->article['page']     = ',pageList,';
$config->block->categoryGroups->article['blog']     = ',blogTree,subscribe,latestBlog,';
$config->block->categoryGroups->product['product']  = ',productTree,latestProduct,hotProduct,featuredProduct,';
$config->block->categoryGroups->custom['custom']    = ',html,htmlcode,phpcode,baidustat,tabs,';
