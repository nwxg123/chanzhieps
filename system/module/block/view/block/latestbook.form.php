...
<tr>
  ...
  <td><div class='input-group'><?php echo html::select('params[sort]', $this->lang->block->book->sortList, isset($block->content->sort) ? $block->content->sort : 'order', "class='form-control chosen'");?></div></td>
</tr>
<tr>
  <th><?php echo $lang->block->book->showType;?></th>
  <td><div class='input-group'><?php echo html::select('params[showType]', $this->lang->block->book->showTypeList, isset($block->content->showType) ? $block->content->showType : 'block', "class='form-control chosen'");?></div></td>
</tr>
<tr>
