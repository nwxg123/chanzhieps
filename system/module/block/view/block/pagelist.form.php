...
<tr>
  ...
  <td><div class='checkbox-primary'><input type='checkbox' name='params[time]' <?php if(isset($block->content->time) && $block->content->time) echo 'checked';?> value='1' /><label></label></div></td>
</tr>
