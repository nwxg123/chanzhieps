...
<div class='panel'>
  ...
  <div class='panel-body'>
    <div class='table-row'>
      <div class='tab-content table-cell col-xs-8'>
        <div class='tab-pane theme-control-tab-pane' id='contentTab'>
          <table align='center' class='table table-form mg-0'>
            ...
            <tr>
              ...
              <td>
                <div class='row'>
                  <div class='col-sm-6'><?php echo html::select('params[icon]', '', '', "class='chosen-icons' data-drop_width='700' data-value='{$config->block->defaultIcons[$type]}'");?></div>
                </div>
              </td>
            </tr>
            <?php endif;?>
