    ...
    <table class='table table-form w-p90'>
      <tbody>
        <tr>
          ...
          <td>
            <?php echo html::select('sideGrid', $lang->ui->theme->sideGridList, $sideGrid, "class='form-control chosen'");?>
          </td>
        </tr>
        <tr>
          <th><?php echo $lang->block->sideFloat ?></th>
          <td>
            <?php echo html::select('sideFloat', $lang->ui->theme->sideFloatList, $sideFloat, "class='form-control chosen'");?>
          </td>
        </tr>
        <tr>
