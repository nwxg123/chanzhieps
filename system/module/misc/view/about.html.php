...
<div class='row'>
  ...
  <div class='col-xs-6' style='border-left: 1px solid #ddd'>
    <ul class='list-unstyled text-gray' id='aboutNav'>
      ...
      <li><?php echo html::a('http://api.chanzhi.org/goto.php?item=support' . $langParam, "<i class='icon-question-circle'></i> " . $lang->misc->support, "target='_blank'")?></li>
      ...
      <li><?php echo html::a('http://api.chanzhi.org/goto.php?item=forum' . $langParam, "<i class='icon-comments'></i> " . $lang->misc->forum, "target='_blank'")?></li>
    </ul>
  </div>
</div>
