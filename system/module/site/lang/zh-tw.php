...
$lang->site->moduleSummary->article    = '系統地發佈和管理文章內容';
$lang->site->moduleSummary->blog       = '通過博客在網上寫文發聲';
$lang->site->moduleSummary->page       = '為網站添加自定義單獨頁面';
$lang->site->moduleSummary->book       = '用戶寫章節型的幫助手冊等';
$lang->site->moduleSummary->user       = '系統自帶的會員管理模組';
$lang->site->moduleSummary->forum      = '用戶主題話題和會員交流';
$lang->site->moduleSummary->score      = '會員積分相關';
$lang->site->moduleSummary->message    = '用戶對文章/產品等發表評論';
$lang->site->moduleSummary->submission = '會員經審核後可以發佈文章';
$lang->site->moduleSummary->shop       = '包含訂單管理的交易模組';
$lang->site->moduleSummary->product    = '系統自帶的產品管理';
$lang->site->moduleSummary->search     = '全站全文搜索功能';
$lang->site->moduleSummary->stat       = '對網站的各種信息進行統計';
...
$lang->site->mobileTemplateTip = '啟動時可以使用移動端主題，禁用時移動端訪問顯示自適應的web端主題';
$lang->site->gzipOutputTip     = '頁面數據會壓縮，訪問時網頁加載速度會變快，還會有利於搜索引擎的抓取';
$lang->site->setDomainTip      = '所有網站訪問跳轉至該域名，請確保域名解析正確，該值為空時不進行跳轉';
$lang->site->setCDNTip         = '目前僅支持CSS（蟬知原版檔案等CSS檔案）和JS（chanzhi（eps）www / js下所有的 *.all.*.js）檔案加速';
...
$lang->site->shortcuts['order']      = '訂單';
$lang->site->shortcuts['message']    = '反饋';
$lang->site->shortcuts['thread']     = '主題';
$lang->site->shortcuts['forumreply'] = '回帖';
$lang->site->shortcuts['article']    = '文章';
$lang->site->shortcuts['page']       = '單頁';
$lang->site->shortcuts['blog']       = '博客';
$lang->site->shortcuts['book']       = '手冊';
$lang->site->shortcuts['submission'] = '投稿';
$lang->site->shortcuts['product']    = '產品';
$lang->site->shortcuts['user']       = '會員';
$lang->site->shortcuts['wechat']     = '微信公眾號';
$lang->site->shortcuts['stat']       = '統計';
$lang->site->shortcuts['tag']        = '關鍵詞';
$lang->site->shortcuts['links']      = '友情連結';
$lang->site->shortcuts['site']       = '系統';
$lang->site->shortcuts['security']   = '安全';
