  ...
  <form method='post' id='setBasicForm'>
    <table class='table table-form'>
      ...
      <tr>
        ...
        <td>
          <?php echo html::radio('mobileTemplate', $lang->site->mobileTemplateList, $this->config->site->mobileTemplate, "class='checkbox'");?>
          <span class="text-important"><?php echo $lang->site->mobileTemplateTip;?></span>
        </td><td></td>
      </tr>
      <tr>
        <th><?php echo $lang->site->gzipOutput;?></th> 
        <td>
          <?php echo html::radio('gzipOutput', $lang->site->gzipOutputList, isset($this->config->site->gzipOutput) ? $this->config->site->gzipOutput : 'close', "class='checkbox'");?>
          <span class="text-important"><?php echo $lang->site->gzipOutputTip;?></span>
        </td><td></td>
      </tr>
      <tr>
          ...
          <div class='row'>
            ...
            <div class='col-sm-8'>
              <div class='input-group'>
                ...
                <?php echo html::input('policeLink', isset($this->config->site->policeLink) ? $this->config->site->policeLink : 'http://www.beian.gov.cn', "class='form-control'")?>
              </div>
            </div>
          </div>
        </td>
