        ...
        <tr>
          ...
          <td class='w-p40'>
            <div class="checkbox-primary">
              <input type='checkbox' name='allowUpload' value='1' <?php if(isset($this->config->site->allowUpload) and $this->config->site->allowUpload) echo 'checked'?>/>
              <label for="allowUpload" class="no-margin"></label>
            </div>
          </td><td></td>
        </tr>
        <tr>
          <th class='top'><?php echo $lang->site->allowedFiles;?></th>
          <td colspan='2'>
