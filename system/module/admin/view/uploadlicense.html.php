...
<?php
/**
 * The upload license file of admin module of ChanZhiEPS.
 *
...
<?php elseif($canManage['result'] == 'success'):?>
...
<div>
  ...
  <div class='text-right'><?php echo html::a($this->inlink('uploadlicense'), $lang->confirm, "class='btn btn-primary okFile'");?></div>
</div>
<?php endif;?>
