...
.editor-wrapper.fullscreen {position: fixed; left: 50px; top:80px; bottom: 40px; right: 0; z-index: 10}
...
jQuery.fn.codeeditor = function(options)
{
    return this.each(function()
    {
        ...
        $this.before('<div class="editor-wrapper"><div class="actions"><a href="javascript:;" class="btn-fullscreen"><i class="icon icon-unfold"></i></a></div><pre id="{0}"></pre><div class="editor-resizer"><i class="icon icon-sort"></i></div></div>'.format(id));
