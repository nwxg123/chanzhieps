...
$lang->detail            = '詳情';
$lang->searchPlaceholder = '請輸入關鍵字';
$lang->selectDate        = '選擇日期';
$lang->bindWechat        = '請先綁定您的微信';
...
$lang->groups->content    = array('title' => '內容', 'link' => 'article|admin|type=article', 'icon' => 'content');
$lang->groups->statistics = array('title' => '統計', 'link' => 'stat|summary',               'icon' => 'statistics');
$lang->groups->promote    = array('title' => '推廣', 'link' => 'tag|admin|',                 'icon' => 'horn');
$lang->groups->shop       = array('title' => '商城', 'link' => 'order|stat|',                'icon' => 'shopping');
$lang->groups->user       = array('title' => '會員', 'link' => 'user|admin|',                'icon' => 'verify');
$lang->groups->design     = array('title' => '設計', 'link' => 'ui|settemplate|',            'icon' => 'design');
$lang->groups->site       = array('title' => '站點', 'link' => 'site|setbasic|',             'icon' => 'site');
...
$lang->menu->setTemplate    = '我的主題|ui|settemplate|';
$lang->menu->themeStore     = '主題市場|ui|themeStore|';
$lang->menu->desktop_top    = '桌面端導航|nav|admin|type=desktop_top';
$lang->menu->desktop_blog   = '桌面端博客導航|nav|admin|type=desktop_blog';
$lang->menu->mobile_top     = '移動端導航|nav|admin|type=mobile_top';
$lang->menu->mobile_blog    = '移動端博客導航|nav|admin|type=mobile_blog';
$lang->menu->browsesource   = '素材庫|file|browsesource|';

$lang->menu->site          = '系統|site|sethomemenu|';
...
$lang->menu->wechat        = '微信公眾號|wechat|admin|';
$lang->menu->bear          = '熊掌號|bear|setting|';
$lang->menu->basic         = '站點|site|setbasic|';
$lang->menu->module        = '模組|site|setmodule|';
$lang->menu->seo           = 'SEO|site|setseo|';
$lang->menu->http          = '網絡|site|setwebsite|';

$lang->menu->package        = '插件|package|browse|';
$lang->menu->community      = '社區|admin|register|';
$lang->menu->chanzhiLicense = '蟬知授權|admin|license|';

$lang->menu->articleCreate  = '發佈文章|article|create|type=article';
$lang->menu->productCreate  = '添加產品|product|create|';
$lang->menu->feedback       = '處理反饋|message|admin|';
$lang->menu->siteSetting    = '站點設置|site|setBasic|';
$lang->menu->companyInfo    = '公司信息|company|setBasic|';
$lang->menu->contact        = '聯繫方式|company|setContact|';
...
$lang->designMenus->theme     = array('link' => '主題|ui|settemplate|', 'alias' => 'themestore,design,customtheme');
$lang->designMenus->block     = array('link' => '區塊|block|admin|', 'alias' => 'create');
$lang->designMenus->nav       = array('link' => '導航|nav|admin|');
$lang->designMenus->component = array('link' => '組件|ui|setlogo|', 'alias' => 'setlogo,effect,browsesource');
...
$lang->article->menu->browse = '文章類目|article|admin|';

/* Menu of blog module. */
$lang->blog = new stdclass();
$lang->blog->menu = new stdclass();
$lang->blog->menu->browse = '博客類目|article|admin|type=blog';
...
$lang->orderSetting->menu->transaction = '交易設置|product|setting|';
$lang->orderSetting->menu->express     = '快遞設置|tree|browse|type=express';

/* Menu of product module. */
$lang->product = new stdclass();
$lang->product->menu = new stdclass();
$lang->product->menu->category = array('link' => '分類目錄|product|admin|', 'alias' => 'create, category');
...
$lang->site->menu->language  = '語言設置|site|setlanguage|';
...
$lang->site->menu->stateinfo = '積分結算|score|showstateinfo|';
$lang->site->menu->mail      = array('link' => '郵箱設置|mail|admin|', 'alias' => 'detect,edit,save,test');
$lang->site->menu->oauth     = '第三方登錄|site|setoauth|';
...
$lang->security->menu->admin       = array('link' => '管理員|user|admin|user=&orderBy=&recTotal=&recPerPage=&pageID=&status=admin&admin=1', 'alias' => 'delete,batchdelete');
...
$lang->order->menu->stat    = '訂單概覽|order|stat|';
$lang->order->menu->product = '商品訂單|order|admin|type=shop';
$lang->order->menu->score   = '積分訂單|order|admin|type=score';
...
$lang->traffic->menu->from     = '來源分類|stat|from|';
$lang->traffic->menu->domains  = array('link' => '來路域名|stat|domainlist|', 'alias' => 'domaintrend,domainpage');
$lang->traffic->menu->search   = '搜索引擎|stat|search|';

$lang->visitor = new stdclass();
$lang->visitor->menu = new stdclass();
$lang->visitor->menu->guest   = '訪客人數|stat|guest|';
$lang->visitor->menu->os      = '操作系統|stat|os|';
$lang->visitor->menu->browser = '瀏覽器|stat|browser|';
$lang->visitor->menu->device  = '終端設備|stat|device|';

$lang->ranking = new stdclass();
$lang->ranking->menu = new stdclass();
$lang->ranking->menu->clickRank   = '點擊排行|stat|clickrank|';
$lang->ranking->menu->articleRank = '文章排行|stat|articlerank|';
$lang->ranking->menu->productRank = '產品排行|stat|productrank|';
...
$lang->pager->digest       = "共 <strong>%s</strong> 條記錄，%s &nbsp; ";
$lang->pager->recPerPage   = "每頁 <strong>%s</strong> 條";
$lang->pager->first        = "<i class='icon-page-first icon-lg' title='首頁'></i>";
$lang->pager->pre          = "<i class='icon icon-angle-left icon-lg' title='上一頁'></i>";
$lang->pager->next         = "<i class='icon-angle-right icon-lg' title='下一頁'></i>";
$lang->pager->last         = "<i class='icon-page-last icon-lg' title='末頁'></i>";
...
$lang->encrypt->free       = '試用版';
$lang->encrypt->personal   = '個人版';
$lang->encrypt->enterprise = '企業版';
$lang->encrypt->pro        = '專業版';
